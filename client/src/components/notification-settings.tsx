        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={settings.categories.updates}
                onCheckedChange={(checked) => 
                  saveSettings({ 
                    ...settings, 
                    categories: { ...settings.categories, updates: checked }
                  })
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Prayer times and task reminders</p>
              </div>
              <Switch
                ...
                onCheckedChange={(checked) => 
                  saveSettings({ 
                    ...settings, 
                    categories: { ...settings.categories, reminders: checked }
                  })
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label>Social</Label>
                <p className="text-sm text-muted-foreground">Team messages and social updates</p>
              </div>
              <Switch
